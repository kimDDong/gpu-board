...
```bash
curl -X POST https://gpu-board.onrender.com/api/users   -H "Content-Type: application/json"   -d '{
    "id": "user16",
    "name": "강하늘",
    "role": "일반 사용자",
    "expiry": "2025-12-31"
...
```bash
curl -X POST https://gpu-board.onrender.com/api/roles   -H "Content-Type: application/json"   -d '{
    "role": "관리자",
